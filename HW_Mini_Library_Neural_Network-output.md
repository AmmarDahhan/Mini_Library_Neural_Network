...
```
├── 📁 __pycache__/
│   ├── 📄 layers.cpython-312.pyc (5.04 KB)
│   ├── 📄 network.cpython-312.pyc (4.92 KB)
│   └── 📄 optimizer.cpython-312.pyc (2.76 KB)
├── 📄 layers.py (2.82 KB)
├── 📄 network.py (3.03 KB)
├── 📄 optimizer.py (1.34 KB)
├── 📄 README.md (5.68 KB)
└── 📄 train.py (2.36 KB)
```
...
### <a id="📄-optimizer-py"></a>📄 `optimizer.py`
